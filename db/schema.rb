...
ActiveRecord::Schema[7.0].define(version: 2023_04_11_023122) do
  ...
  create_table "listings", force: :cascade do |t|
    ...
    t.decimal "num_baths", precision: 4, scale: 1, null: false
    t.decimal "num_beds", precision: 4, scale: 1, null: false
    t.string "latitude"
    t.string "longitude"
